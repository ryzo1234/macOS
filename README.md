...
- Finder z wirtualnym systemem plików, breadcrumbs, historią wstecz/dalej, panelem metadanych i otwieraniem dokumentów w powiązanych aplikacjach,
...
- skróty do plików i zakładek, które uruchamiają Notatki, Kalendarz, Muzykę lub Safari z konkretną zawartością,
...
- Quick Look w Finderze z podglądem tekstów, palet kolorów, obrazów oraz przyciskiem szybkiego przejścia do powiązanej aplikacji,
- Notatki z dynamiczną listą wpisów, informacją o ostatniej aktualizacji i powiadomieniami dla akcji paska narzędzi,
